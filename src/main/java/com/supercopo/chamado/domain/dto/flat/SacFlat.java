...
public class SacFlat {
	...
	public SacFlat(Integer id, String problema, String credito, String devolucao, BigDecimal valorcredito,
			String observacao, String cliente, String vendedor, String transportadora, String tipopedido, String pedido,
			Date dataprevisao, OffsetDateTime datagravacao, String loginusuario, String empresa, String setor,
			String frete, Double custoTotal, Boolean status) {
		this.id = id;
