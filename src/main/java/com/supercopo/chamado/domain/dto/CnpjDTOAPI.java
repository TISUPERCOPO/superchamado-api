...
public class CnpjDTOAPI {
	...
	public CnpjDTOAPI(List<AtividadeCnae> atividade_principal, String nome, String cnpj, String logradouro,
			String numero, String cep, String municipio, String uf, String telefone, String fantasia, String bairro,
			String complemento, String naturezaPessoa, String cnae_fiscal_descricao, String cnae_fiscal,
			String nome_fantasia, String razao_social) {
