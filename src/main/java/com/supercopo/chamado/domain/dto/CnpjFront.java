...
public class CnpjFront {
	...
	public CnpjFront(String nome, String cnpj, String logradouro, String numero, String cep, String municipio,
			String uf, String telefone, String fantasia, String razaosocial, String bairro, String cnaefiscal,
			String cnaefiscaldescricao, String complemento, String naturezapessoa) {
		this.nome = nome;
		this.cnpj = cnpj;
