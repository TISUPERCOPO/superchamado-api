...
import com.supercopo.chamado.domain.dto.flat.ClassePermissaoFlat;
import com.supercopo.chamado.repository.ClassepermissaoRepository;
...
public class ClassepermissaoService {
	...
	public Classepermissao buscarOuFalhar(int id) {
		return repo.findById(id).orElseThrow(
				() -> new EntidadeNaoEncontradaExcepition(String.format("Classepermissao não encontrada", id)));
	}
